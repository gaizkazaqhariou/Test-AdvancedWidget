...
public class TestB2AdvancedWidgetsX081 extends ViewTest {
    ...
    public void check_01_Before_Game() { //Check Layout Specification
        TextView disp = activity.findViewById(R.id.clrText);

        activity.findViewById(R.id.color1).performClick();
        testItem("", disp.getText().toString(), "clrText text should be \"\"", 1);
        activity.findViewById(R.id.color2).performClick();
        testItem("", disp.getText().toString(), "clrText text should be \"\"", 1);
        activity.findViewById(R.id.color3).performClick();
        testItem("", disp.getText().toString(), "clrText text should be \"\"", 1);
        activity.findViewById(R.id.color4).performClick();
        testItem("", disp.getText().toString(), "clrText text should be \"\"", 1);
        activity.findViewById(R.id.color5).performClick();
        testItem("", disp.getText().toString(), "clrText text should be \"\"", 1);
        activity.findViewById(R.id.color6).performClick();
        testItem("", disp.getText().toString(), "clrText text should be \"\"", 1);
    }
    ...
    public void check_02_Right_Answer() {
        ...
        TextView clrText = activity.findViewById(R.id.clrText);
        ProgressBar progress = activity.findViewById(R.id.progressScore);
        TextView score = activity.findViewById(R.id.scoreText);
        ...
        testItem(false, getFieldValue(activity, "isStarted"), "isStarted should be false", 1);
        testItem(View.VISIBLE, activity.findViewById(R.id.startBtn).getVisibility(), "startBtn should be VISIBLE", 1);
    ...
    public void check_03_Wrong_Answer() {
        ...
        ProgressBar progress = activity.findViewById(R.id.progressScore);
        TextView score = activity.findViewById(R.id.scoreText);
        Switch minus = activity.findViewById(R.id.isMinus);
        int counter = activity.getResources().getInteger(R.integer.counter);
        String exTxt;
    ...
    private void clickCorrectButton(String clr) {
        ...
        activity.findViewById(compId).performClick();
    }
