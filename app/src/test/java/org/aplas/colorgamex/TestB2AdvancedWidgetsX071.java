...
public class TestB2AdvancedWidgetsX071 extends ViewTest {
    ...
    public void check_02_Start_Game() {
        ...
        testItem(View.INVISIBLE, activity.findViewById(R.id.startBtn).getVisibility(), "startBtn should be INVISIBLE", 1);
        testItem(true, getFieldValue(activity, "isStarted"), "isStarted should be true", 1);
